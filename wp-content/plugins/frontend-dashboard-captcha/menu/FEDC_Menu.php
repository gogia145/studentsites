...
if ( ! class_exists( 'FEDC_Menu' ) ) {
	...
	class FEDC_Menu {
		...
		public function __construct() {
			...
			add_filter( 'fed_custom_input_fields', array( $this, 'fed_captcha_custom_input_fields' ), 10, 3 );
		...
		public function fed_captcha_custom_input_fields( $input, $values, $attr ) {
			if ( $values['input_type'] === 'content' ) {
				$input = $attr['content'];
			}
