...
class Bunyad_Core
{
	...
	{	
		 ...
		 */
		add_filter('bunyad-active-widgets', array($this, '_filter_widgets'));
	 ...
	 * @param array $widgets
	 */
	public function _filter_widgets($widgets)
	{
	...
	{
		// Return empty for older versions - VERSION was added in 1.0.2
		if (class_exists('Sphere_Plugin_Core') && !defined('Sphere_Plugin_Core::VERSION')) {
			return array();
		}
