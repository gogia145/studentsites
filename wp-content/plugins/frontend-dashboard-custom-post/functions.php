	...
	$labels = array(
		...
		'Label Settings' => array(
			...
			'add_new_item'          => array(
				...
				'help_message' => fed_show_help_message( array( 'content' => 'Default is Add New Post/Add New Page.' ) )
			),
			'add_new'               => array(
			...
			'remove_featured_image' => array(
				...
				'input'        => array(
					'placeholder' => __( '(eg) Remove featured image for this Movie', 'frontend-dashboard-custom-post' ),
					'input_type'  => 'single_line',
			...
			'use_featured_image'    => array(
				...
				'input'        => array(
					'placeholder' => __( '(eg) Use as featured image for this Movie', 'frontend-dashboard-custom-post' ),
					'input_type'  => 'single_line',
	...
	$labels = array(
		'Basic Settings' => array(
			'slug'          => array(
				...
				'required'     => true,
				'help_message' => fed_show_help_message( array(
					'content' => 'Taxonomy slug, No Capital letter, space and special characters'
				) )
			),
			'label'         => array(
				'name'         => __( 'Plural Name', 'frontend-dashboard-custom-post' ),
				...
				'required'     => true,
				'help_message' => fed_show_help_message( array( 'content' => ' A plural descriptive name for the taxonomy marked for translation.' ) )
			),
			'singular_name' => array(
				'name'         => __( 'Singular Name', 'frontend-dashboard-custom-post' ),
				'input'        => array(
				...
				'required'     => true,
				'help_message' => fed_show_help_message( array( 'content' => 'General name for the taxonomy, usually singular.' ) )
			),
			'fed_extra'     => array(
				...
				'required'     => true,
				'help_message' => fed_show_help_message( array(
					'content' => 'Select any one post type'
				) )
			),
		),
		'Label Settings' => array(
			'name'                       => array(
				...
				'help_message' => fed_show_help_message( array( 'content' => 'General name for the taxonomy, usually plural.' ) )
			),
			'menu_name'                  => array(
				'name'         => __( 'Menu Name', 'frontend-dashboard-custom-post' ),
				'input'        => array(
			...
			'new_item_name'              => array(
				...
				'help_message' => fed_show_help_message( array( 'content' => 'Default is New Item Name' ) )
			),
			'edit_item'                  => array(
				'name'         => __( 'Edit Item', 'frontend-dashboard-custom-post' ),
				'input'        => array(
			...
			'update_item'                => array(
				...
				'help_message' => fed_show_help_message( array( 'content' => 'Default is Update Item' ) )
			),
			'parent_item'                => array(
			...
			'description'                => array(
				...
				'help_message' => fed_show_help_message( array( 'content' => 'A short descriptive summary of what the taxonomy is.' ) )
			),
			'popular_items'              => array(
				...
				'help_message' => fed_show_help_message( array( 'content' => 'The popular items text. This string is not used on hierarchical taxonomies. Default is Popular Tags or null' ) )
			),
			'separate_items_with_commas' => array(
				...
				'help_message' => fed_show_help_message( array( 'content' => 'The separate item with commas text used in the taxonomy meta box. This string is not used on hierarchical taxonomies. Default is __( \'Separate tags with commas\' ), or null' ) )
			),
			'add_or_remove_items'        => array(
				...
				'help_message' => fed_show_help_message( array( 'content' => 'the add or remove items text and used in the meta box when JavaScript is disabled. This string is not used on hierarchical taxonomies. Default is __( \'Add or remove tags\' ) or null' ) )
			),
			'choose_from_most_used'      => array(
				...
				'help_message' => fed_show_help_message( array( 'content' => 'the choose from most used text used in the taxonomy meta box. This string is not used on hierarchical taxonomies. Default is __( \'Choose from the most used tags\' ) or null' ) )
			),
		),
		'Settings'       => array(
			'hierarchical'       => array(
				...
				'help_message' => fed_show_help_message( array( 'content' => 'Whether the taxonomy is hierarchical (e.g. page). Allows Parent to be specified. The supports parameter should contain page-attributes to show the parent select box on the editor page..' ) )
			),
			'show_tagcloud'      => array(
				...
				'help_message' => fed_show_help_message( array( 'content' => 'Whether to allow the Tag Cloud widget to use this taxonomy.' ) )
			),
			'show_in_quick_edit' => array(
				...
				'help_message' => fed_show_help_message( array( 'content' => 'Whether to show the taxonomy in the quick/bulk edit panel' ) )
			),
			'show_admin_column'  => array(
				...
				'help_message' => fed_show_help_message( array( 'content' => 'Whether to allow automatic creation of taxonomy columns on associated post-types table' ) )
			),
			'sort'               => array(
				...
				'help_message' => fed_show_help_message( array( 'content' => 'Whether this taxonomy should remember the order in which terms are added to objects' ) )
			),
			'public'             => array(
				'name'         => __( 'Public', 'frontend-dashboard-custom-post' ),
				'input'        => array(
			...
			'show_ui'            => array(
				...
				'help_message' => fed_show_help_message( array( 'content' => 'Whether to generate a default UI for managing this taxonomy in the admin.' ) )
			),
			'show_in_menu'       => array(
				'name'         => __( 'Show in Menu', 'frontend-dashboard-custom-post' ),
				'input'        => array(
				...
				'help_message' => fed_show_help_message( array( 'content' => 'Where to show the taxonomy in the admin menu' ) )
			),
			'show_in_nav_menus'  => array(
				'name'         => __( 'Show in Nav Menus', 'frontend-dashboard-custom-post' ),
				'input'        => array(
			...
			'query_var'          => array(
				...
				'help_message' => fed_show_help_message( array( 'content' => 'Sets the query_var key for this taxonomy.' ) )
			),
			'show_in_rest'       => array(
				'name'         => __( 'Show in REST', 'frontend-dashboard-custom-post' ),
				'input'        => array(
				...
				'help_message' => fed_show_help_message( array( 'content' => 'Whether to expose this taxonomy in the REST API.' ) )
			),
			'rest_base'          => array(
				'name'         => __( 'REST base', 'frontend-dashboard-custom-post' ),
				'input'        => array(
				...
				'help_message' => fed_show_help_message( array( 'content' => 'The base slug that this taxonomy will use when accessed using the REST API.' ) )
			),
			'rewrite'            => array(
				'name'         => __( 'Rewrite URL', 'frontend-dashboard-custom-post' ),
				'input'        => array(
				...
				'help_message' => fed_show_help_message( array( 'content' => 'Triggers the handling of rewrites for this taxonomy. To prevent rewrites, set to false.' ) )
			),
			'rewrite_slug'       => array(
				'name'         => __( 'Rewrite URL Slug', 'frontend-dashboard-custom-post' ),
				'input'        => array(
	...
	foreach ( $taxonomies as $index => $taxonomy ) {
		...
		$new_tax[ $index ] = array(
			...
			'input' => array(
				...
				'label'         => __( $taxonomy->label . $wp_core_tax, 'frontend-dashboard-custom-post' ),
				'default_value' => 'Enable'
			)
		);
	}
...
function fed_cp_checkbox_taxonomies_with_users( array $request = array(), $tax_name = null ) {
	...
	foreach ( $taxonomies as $index => $taxonomy ) {
		$wp_core_tax       = in_array( $index, $core_tax, true ) ? ' (WP Core)' : '';
		$new_tax[ $index ] = array(
			'heading' => __( $taxonomy->label . $wp_core_tax, 'frontend-dashboard-custom-post' ),
		);
		foreach ( $users as $key => $user ) {
			$new_tax[ $index ]['extra'][ $key ] = array(
				'input_type'    => 'checkbox',
				'user_value'    => isset( $request[ $tax_name ]['taxonomies'][ $index ][ $key ] ) ? $request[ $tax_name ]['taxonomies'][ $index ][ $key ] : '',
				'input_meta'    => 'taxonomies[' . $index . '][' . $key . ']',
				'label'         => __( $user, 'frontend-dashboard-custom-post' ),
				'default_value' => 'Enable'
			);
		}
	}
			...
			<div class="modal-dialog modal-lg"
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title"><?php _e( 'Please Select one Image', 'frontend-dashboard-custom-post' ) ?></h4>
					</div>
