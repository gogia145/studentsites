	...
	<div <?php Bunyad::markup()->attribs('top-bar', array('class' => array('top-bar', Bunyad::options()->topbar_style))); ?>>
		...
		<div class="wrap">
			<section class="top-bar-content cf">
				...
				<?php if (Bunyad::options()->topbar_date): ?>
				...
				<div class="trending-ticker">
					...
					?>
						<?php $query = new WP_Query(apply_filters('bunyad_ticker_query_args', array('orderby' => 'date', 'order' => 'desc', 'posts_per_page' => 8,'meta_key'=>'_select_campus','meta_value'=>$campus_value))); ?>
				...
				<?php endif; ?>
				<div class="mid-menu mid-menu-mobile">
				<?php
				  wp_nav_menu( array(
					'menu' => 'Mid Menu'
				) ); 
